...
ggplot(world_map) + geom_sf(aes(fill = Happiness_Score))  
...
-   **Longitudinal Analysis**: Observe how happiness scores have evolved before and after significant events (e.g., economic crises, policy changes, or the COVID-19 pandemic).
